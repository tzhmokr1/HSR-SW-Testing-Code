...
DROP TABLE BLC_TESTING_TIME IF EXISTS;
CREATE TABLE BLC_TESTING_TIME (id INT NOT NULL, TESTING_TIME TIMESTAMP, PRIMARY KEY (id));

INSERT INTO BLC_TESTING_TIME(id, TESTING_TIME) values (42, '2018-01-01 00:00:00');
...
INSERT INTO BLC_OFFER (OFFER_ID, OFFER_NAME, START_DATE, END_DATE, OFFER_TYPE, OFFER_DISCOUNT_TYPE, OFFER_VALUE, COMBINABLE_WITH_OTHER_OFFERS, APPLY_TO_SALE_PRICE, MAX_USES, OFFER_ITEM_TARGET_RULE, AUTOMATICALLY_ADDED, APPLY_TO_CHILD_ITEMS) VALUES (1, 'Shirts Speciaaaal',CURRENT_DATE,'2020-01-01 00:00:00','ORDER_ITEM','PERCENT_OFF',20,TRUE,FALSE,0, 'NONE', FALSE, FALSE);
...
-- Adding the weekend discount offer for testing purposes
INSERT INTO BLC_OFFER (OFFER_ID, OFFER_NAME, START_DATE, END_DATE, OFFER_TYPE, OFFER_DISCOUNT_TYPE, OFFER_VALUE, COMBINABLE_WITH_OTHER_OFFERS, APPLY_TO_SALE_PRICE, MAX_USES, OFFER_ITEM_TARGET_RULE, AUTOMATICALLY_ADDED, APPLY_TO_CHILD_ITEMS) VALUES (1001, 'WeekendDiscount','2018-01-17 00:00:00','2029-01-01 00:00:00','ORDER_ITEM','PERCENT_OFF',50,TRUE,TRUE,0, 'NONE', TRUE, FALSE);

INSERT INTO BLC_OFFER_ITEM_CRITERIA (OFFER_ITEM_CRITERIA_ID, ORDER_ITEM_MATCH_RULE, QUANTITY) VALUES (1000, 'orderItem.?quantity>=1', 1);

INSERT INTO BLC_TAR_CRIT_OFFER_XREF (OFFER_TAR_CRIT_ID, OFFER_ITEM_CRITERIA_ID, OFFER_ID) VALUES (1, 1000, 1001);
