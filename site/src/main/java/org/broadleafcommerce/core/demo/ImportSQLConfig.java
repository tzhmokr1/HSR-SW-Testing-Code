...
import org.broadleafcommerce.common.demo.*;
...
public class ImportSQLConfig {
    ...
    public AutoImportSql blFrameworkPreBasicData() {
        return new AutoImportSql(AutoImportPersistenceUnit.BL_PU,"config/bc/sql/demo/hsr/load_catalog_data.sql,config/bc/sql/demo/load_catalog_i18n_data_ES.sql," +
